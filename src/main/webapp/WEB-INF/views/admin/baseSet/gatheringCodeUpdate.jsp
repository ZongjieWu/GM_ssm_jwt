    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">设置收款码</div>
                <div class="layui-card-body" pad15>
                    <div class="layui-form" id="admin" lay-filter="">
                        <div class="layui-upload">
                            <div class="layui-input-inline" id="test1">
                                <div class="layui-upload-list">
                                    <img class="layui-upload-img" id="demo1" style="width: 150px;height:150px;" src="<%=path%>/${gatheringCode.img}">
                                    <p id="demoText"></p>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    layui.use(['form','layer','upload'], function(){
        ...
        var uploadInst = upload.render({
            ...
            ,data: {
                baseCatalog: "/static/upload/image/gatheringCode"
            }
            ,before: function(obj){
                //预读本地文件示例，不支持ie8
        ...
        form.on("submit(setmyinfo)",function(res){
                ...
                data.id=1;
                data.img=headImg;
                $.post("<%=path%>/gatheringCode/update",data,function(res){
                    if(res.code==0){
                        layer.msg(res.msg);
                    }else{
                        layer.msg(res.msg);
