    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="table-useradmin-webuser">
                <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail"><i class="layui-icon layui-icon-search"></i><span>查看</span></a>
...
<script>
    ...
    layui.use(['form','layer','table'], function(){
        ...
        table.render({
            elem: '#demo'
            // ,height: 700
            ,url: '<%=path%>/userResume/paging' //数据接口
            ,method:"post"
            ,where: {status: 1}
            ,page: true //开启分页
            ,limit:10
...
//                    ,templet:"#nameDemo"
                ...
                ,{field: 'age' ,width:"10%",align:'center', title: '年龄'}
                ,{field: 'findJobStatus' ,width:"10%",align:'center', title: '求职状态',templet:"#findJobStatusTpl"}
        ...
        table.on('tool(demo)', function(obj){
            ...
            if (obj.event === 'detail') {
                popUpBox = layer.open({
                    ...
                    maxmin: true,
                    title: '简历详情',
                    content:'<%=path%>/resume/userResume/jumpDetail?id='+data.id
                })
            }
            // 通过
            if (obj.event === 'update') {
