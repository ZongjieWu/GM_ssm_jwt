                ...
                <div class="layui-card-body" pad15>
                    <div class="layui-form" wid100 lay-filter="">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <c:if test="${userResume.sex==0}">
                                    <input type="text" id="sex" name="sex" lay-verify="sex" class="layui-input" value="男">
                                </c:if>
                                <c:if test="${userResume.sex==1}">
                                    <input type="text" id="sex" name="sex" lay-verify="sex" class="layui-input" value="女">
                                </c:if>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <c:if test="${userResume.education==0}">
                                    <input type="text" id="education" name="education" class="layui-input" value="高中">
                                </c:if>
                                <c:if test="${userResume.education==1}">
                                    <input type="text" id="education" name="education" class="layui-input" value="专科">
                                </c:if>
                                <c:if test="${userResume.education==2}">
                                    <input type="text" id="education" name="education" class="layui-input" value="本科">
                                </c:if>
                                <c:if test="${userResume.education==3}">
                                    <input type="text" id="education" name="education" class="layui-input" value="研究生">
                                </c:if>
                                <c:if test="${userResume.education==4}">
                                    <input type="text" id="education" name="education" class="layui-input" value="博士">
                                </c:if>
                            </div>
                        </div>
                        <div class="layui-form-item layui-form-text">
