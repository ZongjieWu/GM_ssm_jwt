    ...
    document.writeln('<li  onclick="jumpSelfAuthentication();"><a target="user" href="javascript:;"><img src="images/menuIcon/authentication.png" style="width: 8%;"> 进行认证</a></li>');
    document.writeln('<li  onclick="jumpJobList();"><a target="user" href="javascript:;"><img src="images/menuIcon/search.png" style="width: 8%;"> 搜索职位</a></li>');
    ...
    document.writeln('<li onclick="jumpLogout();"><a target="user" href="javascript:;"><img src="images/menuIcon/logou.png" style="width: 8%;"> 退出登入</a></li>');
    document.writeln('</ul>');
