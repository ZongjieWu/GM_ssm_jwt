...
document.writeln('<li>');
document.writeln('<a href="javascript:;"  onclick="jumpFindJob()"><span class="title" style="color: white;">找工作</span></a>');
document.writeln('');			<!-- Level Two-->
document.writeln('</li>');
document.writeln('<li>');
document.writeln('<a href="javascript:;" onclick="jumpFindResume()"><span class="title"  style="color: white;">找人才</span></a>');
document.writeln('');			<!-- Level Two-->
document.writeln('</li>');
document.writeln('<li class="last">');
document.writeln('<a href="javascript:;" onclick="jumpGathering()"><span class="title"  style="color: white;">企业会员充值</span></a>');
document.writeln('</li>');
document.writeln('</ul>');
...
if(JSON.parse(localStorage.getItem("enterprise"))==null){
    document.writeln('<ul class="sign_up_btn pull-right dn-smd mt10">');
    document.writeln('<li><a href="#" class="btn btn-md"  style="margin-top: -4px;" data-toggle="modal" data-target="#exampleModalCenter" onclick="jumpLogin()">企业登入/企业注册</a></li>');
    document.writeln('</ul>');	<!-- Button trigger modal -->
}else{
    ...
    document.writeln('<template v-if="enterpriseLogo==null||enterpriseLogo==\'\'">');
            document.writeln('<a class="btn dropdown-toggle"  style="margin-top: -4px;" href="#" data-toggle="dropdown"><img class="rounded-circle" style="width: 54px;height:54px;" src="/static/upload/image/blank.jpg" alt="8.jpg"> <span class="pl15 pr15" style="width:100px;margin-top:10%;">企业中心</span></a>');
    document.writeln('</template>');
    document.writeln('<template v-else>');
             document.writeln('<a class="btn dropdown-toggle"  style="margin-top: -4px;" href="#" data-toggle="dropdown"><img class="rounded-circle" style="width: 54px;height:54px;" :src="\'/\'+enterpriseLogo" alt="8.jpg"> <span class="pl15 pr15" style="width:100px;margin-top:10%;">企业中心</span></a>');
    document.writeln('</template>');
